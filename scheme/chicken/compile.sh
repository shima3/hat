...
file_ext=${1##*/}
base=${file_ext%.*}
# csc -R chicken.io -R srfi-13 -R srfi-18 -R srfi-69 -prologue chicken/wrapper.scm -epilogue chicken/epilogue.scm -o chicken/$base $*
csc -O4 -R srfi-88 -R queues -R chicken.io -R srfi-13 -R srfi-18 -R srfi-69 -prologue chicken/wrapper.scm -epilogue chicken/epilogue.scm -o chicken/$base $*
