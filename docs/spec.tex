...
\item\NT{function}\lrto
  \hat\ \NT{head} \NT{body}
\item\NT{head}\lrto
  (\NT{symbol}$^*$)
\item\NT{body}\lrto
  \NT{operator} \NT{operand}$^*$ \par
  \| \NT{operator} \NT{operand}$^*$ \NT{function}
\item\NT{operator}\lrto
  \NT{symbol} \| (\NT{function}) \| \NT{list}
\item\NT{operand}\lrto
  \NT{datum} \| ((\NT{function}))
\item\NT{datum}\lrto
  \NT{number} \| \NT{string} \| \NT{symbol} \| \NT{list}
\item\NT{list}\lrto
  (\NT{datum}$^*$)
\end{hang}
