...
var HatInterpreter=(function( ){
    ...
    */
	...
	if(list==null) return "";
	return valueString(list.getFirst())+listString(list.getRest());
    }
...
//	    resetCanvas();
	...
	startTask: function(fun, args){
	    let task=new Task(currentTask.actor, fun, args, null, null);
	    TaskQ.push(task);
	},
	...
	log: function(ret, obj){
	    ...
	    console.log(obj); // データ全体をログに残すため、文字列に変換しない。
	    return null;
	},
